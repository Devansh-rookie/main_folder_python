...
Checkbutton(window, text='C',variable=var_2).grid(row=3,column=1)
...
var_5 = IntVar()
var_6 = IntVar()
Radiobutton(window, text="OK", variable=var_5).grid(row=6,column=1)
Radiobutton(window, text="Cancel", variable=var_6).grid(row=7,column=1)
window.mainloop()